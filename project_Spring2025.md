...
* If you are a Computer Science or PhD student, you must use either Python or Vega-Lite or both to build your final charts. Students that from other departments/graduate programs MUST implement 50% of coding at least to build chart(s) and may use any tool of their choice to build their final charts.
